...
alter table CALL_CENTER change cc_mkt_desc cc_mkt_desc varchar(100) default null COMMENT 'RAPID_COLUMN=ENCODING=SORTED';
...
alter table STORE change s_city s_city varchar(60) default null COMMENT 'RAPID_COLUMN=ENCODING=VARLEN';
...
alter table STORE change s_zip s_zip char(10) default null COMMENT 'RAPID_COLUMN=ENCODING=VARLEN';
